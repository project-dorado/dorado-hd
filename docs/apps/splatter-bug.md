...
- **Official package:** `SplatterBug.exe` (splatter_bug)
- **Corpus:** `Zune HD Apps (Decompiled)/splatter_bug` (external, untracked)
...
_TODO: content totals from `_index/splatter-bug.json`._

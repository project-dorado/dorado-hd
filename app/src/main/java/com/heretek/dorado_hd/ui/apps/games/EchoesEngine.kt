...
object EchoesArenas {
    ...
    val ALL: List<EchoesArena> = listOf(
        ...
        RawArena("quarry", QUARRY),
        RawArena("ravine", RAVINE),
        RawArena("terrace", TERRACE),
        RawArena("plaza", PLAZA),
        RawArena("warren", WARREN),
        RawArena("atoll", ATOLL),
        RawArena("switchback", SWITCHBACK),
        RawArena("crossroads", CROSSROADS),
        RawArena("basin", BASIN),
        RawArena("steps", STEPS),
        RawArena("grotto", GROTTO),
        RawArena("summit", SUMMIT),

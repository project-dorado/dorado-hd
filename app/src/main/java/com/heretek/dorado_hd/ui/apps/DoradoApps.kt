...
fun buildAppRegistry(): List<DoradoMiniApp> = listOf(
    ...
    DoradoMiniApp("weather", "weather", "reading", { com.heretek.dorado_hd.ui.apps.mocks.WeatherApp() }),
    DoradoMiniApp("twitter", "twitter", "social", { com.heretek.dorado_hd.ui.apps.mocks.TwitterApp() }),
    DoradoMiniApp("facebook", "facebook", "social", { com.heretek.dorado_hd.ui.apps.mocks.FacebookApp() }),
    DoradoMiniApp("email", "email", "networking", { com.heretek.dorado_hd.ui.apps.mocks.EmailApp() }),
    DoradoMiniApp("messenger", "messenger", "networking", { com.heretek.dorado_hd.ui.apps.mocks.MessengerApp() }),
    DoradoMiniApp("msnmoney", "msn money", "reading", { com.heretek.dorado_hd.ui.apps.mocks.MsnMoneyApp() }),
    DoradoMiniApp("zunereader", "zune reader", "reading", { com.heretek.dorado_hd.ui.apps.mocks.ZuneReaderApp() }),
    DoradoMiniApp("zunesocial", "social", "social", { com.heretek.dorado_hd.ui.apps.mocks.SocialApp() }),
    ...
    DoradoMiniApp("echoes", "echoes", "games", { com.heretek.dorado_hd.ui.apps.games.EchoesApp() }),
    DoradoMiniApp("labyrinth", "labyrinth", "games", { com.heretek.dorado_hd.ui.apps.games.LabyrinthApp() }),
    DoradoMiniApp("audiosurf-tilt", "audiosurf tilt", "games", { com.heretek.dorado_hd.ui.apps.games.AudiosurfApp() }),
    DoradoMiniApp("lucky-lanes-bowling", "lucky lanes bowling", "games", { com.heretek.dorado_hd.ui.apps.games.BowlingApp() }),
    DoradoMiniApp("pgr-ferrari-edition", "pgr ferrari", "games", { com.heretek.dorado_hd.ui.apps.games.PgrApp() }),
    DoradoMiniApp("vans-sk8-pool-service", "vans sk8", "games", { com.heretek.dorado_hd.ui.apps.games.SkateApp() }),
)

...
object OfficialCatalog {
    ...
    val all: List<OfficialApp> = listOf(
        ...
        OfficialApp("Audiosurf Tilt", "Audiosurf.exe", MUSIC, "Ride your music — a rollercoaster from any song.", "audiosurf-tilt"),
        ...
        OfficialApp("Echoes", "Echoes.exe", GAMES, "Action puzzle game.", "echoes"),
        ...
        OfficialApp("Labyrinth", "Labyrinth.exe", GAMES, "Lead your marble through a colorful world.", "labyrinth"),
        OfficialApp("Level", "Level.exe", UTILITIES, "Spirit level and surface level in one.", "level"),
        OfficialApp("Lucky Lanes Bowling", "bowling.exe", GAMES, "Exhibition, blackjack and golf modes.", "lucky-lanes-bowling"),
        ...
        OfficialApp("PGR: Ferrari Edition", "PGRZune.exe", GAMES, "Streets of London, Tokyo and New York.", "pgr-ferrari-edition"),
        ...
        OfficialApp("Vans Sk8 Pool Service", "Vans.exe", GAMES, "Skate the rooftops and abandoned lots.", "vans-sk8-pool-service"),
